...
(function (F, x, Z) {
    ...
    function V(a, b, c) {
        var d = "";
        a = $(a) ? a : a && M(a) && a.length ? a.split(/\s+/) : [];
        q(a, function (a, y) {
    ...
    function R(a, b, c) {
        ...
        c.preparationClasses && (b.preparationClasses = W(c.preparationClasses, b.preparationClasses), delete c.preparationClasses);
    ...
    var L = x.noop, ya = x.extend, I = x.element, q = x.forEach, $ = x.isArray, M = x.isString, pa = x.isObject, La = x.isUndefined, Ma = x.isDefined, Ca = x.isFunction, qa = x.isElement, N, ra, X, sa;
    F.ontransitionend === Z && F.onwebkittransitionend !== Z ? (N = "WebkitTransition", ra = "webkitTransitionEnd transitionend") : (N = "transition", ra = "transitionend");
    F.onanimationend === Z && F.onwebkitanimationend !==
    Z ? (X = "WebkitAnimation", sa = "webkitAnimationEnd animationend") : (X = "animation", sa = "animationend");
    var ka = X + "Delay", ta = X + "Duration", ga = N + "Delay";
    F = N + "Duration";
    var Na = {
    ...
    }, Oa = {transitionDuration: F, transitionDelay: ga, animationDuration: ta, animationDelay: ka};
    x.module("ngAnimate", []).provider("$$body", function () {
        ...
        ["$animateProvider", function (a) {
            ...
            this.$get = ["$$rAF", "$rootScope", "$rootElement", "$document", "$$body", "$$HashMap", "$$animation", "$$AnimateRunner", "$templateRequest", "$$jqLite", "$$forceReflow", function (d, y, v, z, l, s, O, x, t, la, E) {
                ...
                function u(a, g, m) {
                    ...
                    var B, h;
                    if (a = Fa(a))B = G(a), h = a.parent();
                    m = ia(m);
                    var e =
                        new x;
                    $(m.addClass) && (m.addClass = m.addClass.join(" "));
                    m.addClass && !M(m.addClass) && (m.addClass = null);
                    $(m.removeClass) && (m.removeClass = m.removeClass.join(" "));
                    m.removeClass && !M(m.removeClass) && (m.removeClass = null);
                    m.from && !pa(m.from) && (m.from = null);
                    m.to && !pa(m.to) && (m.to = null);
                    if (!B)return w(), e;
                    ...
                    if (v) {
                        ...
                        if (b("cancel", a, h, k))if (2 === k.state)k.runner.end(); else if (k.structural)k.close(); else return R(a, k.options, h.options), k.runner; else if (b("join", a, h, k))if (2 === k.state)R(a, m, {}); else return Ja(a, l ? g : null, m), g = h.event = k.event, m = R(a, k.options, h.options), k.runner
                    } else R(a, m, {});
                ...
                function p(a, b, c) {
                    ...
                    for ((a = a.data("$ngAnimatePin")) && (b = a); b && b.length;) {
                        ...
                        if (La(d) || !0 === d)a = b.data("$$ngAnimateChildren"), Ma(a) && (d = a);
                        if (f && !1 === d)break;
                ...
                return {
                    on: function (a, b, c) {
                        ...
                        ua(qa(a), "element", "not an element");
                        ua(qa(b), "parentElement", "not an element");
        ...
        this.$get = ["$$jqLite", "$rootScope", "$injector", "$$AnimateRunner", "$$HashMap", "$$rAFScheduler", function (a, e, y, v, z, l) {
            ...
            return function (t, z, E) {
                ...
                var U = va(t.attr("class"), va(E.addClass, E.removeClass)), H = E.tempClasses;
        ...
        this.$get = ["$window", "$$jqLite", "$$AnimateRunner", "$timeout", "$$forceReflow", "$sniffer", "$$rAFScheduler", "$animate", function (a, e, y, v, z, l, s, O) {
            ...
            function t(h, f, l, p) {
                var r;
                0 < b.count(l) && (r = c.get(l), r || (f = V(f, "-stagger"), e.addClass(h, f), r = za(a, h, p), r.animationDuration = Math.max(r.animationDuration,
            ...
            function E(c, f, h) {
                f = b.get(h);
                f || (f = za(a, c, Na), "infinite" === f.animationIterationCount && (f.animationIterationCount = 1));
                b.put(h, f);
                c = f;
                h = c.animationDelay;
                f = c.transitionDelay;
            ...
            return function (a, c) {
                ...
                function A(a) {
                    ...
                    n.blockKeyframeAnimation && na(g, !!a)
                }
                ...
                function H() {
                    function b() {
                        if (!s) {
                            ...
                            n.applyAnimationDelay && (Y = "boolean" !== typeof c.delay && oa(c.delay) ? parseFloat(c.delay) : Y, I = Math.max(Y, 0), D.animationDelay = Y, da = [ka, Y + "s"], w.push(da), g.style[da[0]] = da[1]);
                            M = 1E3 *
                                I;
                            Q = 1E3 * K;
                            if (c.easing) {
                                ...
                                n.hasAnimations && (k = X + "TimingFunction", w.push([k, p]), g.style[k] = p)
                            }
                            D.transitionDuration && m.push(ra);
                            D.animationDuration && m.push(sa);
                            H = Date.now();
                            var u = M + 1.5 * Q;
                            k = H + u;
                ...
                0 < c.stagger ? (C = parseFloat(c.stagger), T = {
                    ...
                    animationDuration: 0
                }) : (ba = x(g, ha), T = t(g, aa, ba, Oa));
                c.$$skipPreparationClasses || e.addClass(a, aa);
                c.transitionStyle && (C =
                    [N, c.transitionStyle], fa(g, C), w.push(C));
                0 <= c.duration && (C = 0 < g.style[N].length, C = Aa(c.duration, C), fa(g, C), w.push(C));
                c.keyframeStyle && (C = [X, c.keyframeStyle], fa(g, C), w.push(C));
                var W = T ? 0 <= c.staggerIndex ? c.staggerIndex : b.count(ba) : 0;
                (ca = 0 === W) && !c.skipBlocking && ja(g, 9999);
                var D = E(g, ha, ba), Y = D.maxDelay;
                I = Math.max(Y, 0);
                K = D.maxDuration;
                var n = {};
                n.hasTransitions = 0 < D.transitionDuration;
                ...
                n.applyTransitionDelay = oa(c.delay) && (n.applyTransitionDuration || n.hasTransitions);
                n.applyAnimationDelay = oa(c.delay) && n.hasAnimations;
                n.recalculateTimingStyles = 0 < P.length;
                if (n.applyTransitionDuration || n.applyAnimationDuration)K = c.duration ? parseFloat(c.duration) : K, n.applyTransitionDuration && (n.hasTransitions = !0, D.transitionDuration = K, C = 0 < g.style[N + "Property"].length, w.push(Aa(K,
                    C))), n.applyAnimationDuration && (n.hasAnimations = !0, D.animationDuration = K, w.push([ta, K + "s"]));
            ...
            "$$AnimateRunner", "$$jqLite", function (b, c, d) {
                ...
                return function (a, b, d, s) {
                    ...
                    function F(a, b, d, e, f) {
                        ...
                        b.push(e);
                        if (a = a.apply(a, b))if (Ca(a.start) &&
                            (a = a.start()), a instanceof c)a.done(f); else if (Ca(a))return a;
                        return L
                    }
                    ...
                    3 === arguments.length && pa(d) && (s = d, d = null);
                    s = ia(s);
