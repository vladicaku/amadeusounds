...
!function (a, b, c) {
    ...
    (function () {
        ...
        b.module("uiGmapgoogle-maps.directives.api.utils").service("uiGmap_sync", [function () {
            ...
            return z = c.promiseTypes, s = c.isInProgress, y = c.promiseStatus, h = c.ExposedPromise, j = c.SniffedPromise, t = function (a, b) {
            ...
            }, m = 80, q = {value: null}, A = function (a, b, c) {
                var d, e;
                try {
                    return a.apply(b, c)
                } catch (e) {
                ...
                var f, g, h;
                if (b.isArray(a))f = a; else if (c)f = c; else {
                    f = [];
            ...
            return n = function (e) {
                ...
                return d(n, e), n.include(f), n.include(h), n.include(j), o = function (a) {
                    ...
                    switch (null == c && (c = void 0), null == d && (d = !1), null == e && (e = !0), null == b ? b = this.model : this.model = b, this.gObject || (this.setOptions(this.scope, e), f = !0), a) {
                        ...
                        case"icon":
                            return this.maybeSetScopeValue({gSetter: this.setIcon, doDraw: e});
                        case"coords":
                            return this.maybeSetScopeValue({gSetter: this.setCoords, doDraw: e});
                        case"options":
                ...
                return c(h, e), h.include(g), h.prototype.restrict = "EMA", h.prototype.transclude = !0, h.prototype.replace = !1, h.prototype.template = '<div class="angular-google-map"><div class="angular-google-map-container">\n</div><div ng-transclude style="display: none"></div></div>', h.prototype.scope = {
                    ...
                    return g = [], a.$on("$destroy", function () {
                        ...
                        return function (i) {
                            ...
                            if (r = {mapTypeId: i.MapTypeId.ROADMAP}, B = j.spawn(), z = function () {
                                    return B.deferred.resolve({instance: B.instance, map: l})
                            ...
                            if (s = b.element(c), s.addClass("angular-google-map"), x = {options: {}}, e.options && (x.options = a.options), e.styles && (x.styles = a.styles), e.type && (C = e.type.toUpperCase(), google.maps.MapTypeId.hasOwnProperty(C) ? x.mapTypeId = google.maps.MapTypeId[e.type.toUpperCase()] : f.error("angular-google-maps: invalid map type '" + e.type + "'")), v = b.extend({}, r, x, {
                                    ...
                                    if (null == c && (c = l.center), null == d && (d = a), !_.includes(n, "center"))if (b.isDefined(d.center.type)) {
